...
**NOTE:** You will need a working installation of R and Git. Follow the R installation 
...
These next commands will install the Biodiverse engine and its perl dependencies.
...
Note that the above will take a while if you do not already have the GDAL 
development package installed on your system.  This is because it will compile
its own version if it is unable to find one on the system (but maybe this
is not such a bad thing as then it will be isolated from system changes). If
you do want to install a system version then see the 
